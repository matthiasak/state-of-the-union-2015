...
var home = function home() {
    return (0, _universalUtils.m)('.home', [(0, _universalUtils.m)('.hr', 'A look into'), (0, _universalUtils.m)('h1', 'The State of the Union.js'), (0, _universalUtils.m)('.hr', 'With this guy'), (0, _universalUtils.m)('img', { style: { width: 'auto' }, src: 'https://pbs.twimg.com/profile_images/684599443908235264/IgNdjWUp.png' }), (0, _universalUtils.m)('.hr', [(0, _universalUtils.m)('a', { href: 'http://mkeas.org/talks' }, 'mkeas.org/talks'), ' • ', (0, _universalUtils.m)('a', { href: 'http://twitter.com/matthiasak' }, '@matthiasak')])]);
};
...
function app() {
    ...
    insert(home, img('https://www.theironyard.com/etc/designs/theironyard/icons/iron-yard-logo.svg', "Passion at the intersection of tech and education.", { width: '50%' }), md("\n# Node by the Numbers\n\n---\n\nhttps://nodesource.com/assets/blog/node-by-numbers/node-by-numbers.pdf\n\n"), img('./images/30.png'), img('./images/31.png'), img('./images/32.png'), img('./images/33.png'), img('./images/34.png'), img('./images/35.png'), img('./images/36.png'), md("\n# An overarching theme: kintsugi\n"), img('./images/kintsugi.jpg'), img('./images/2.png'), img('./images/3.png'), img('./images/5.png'), img('./images/7.png'), img('./images/8.png'), img('./images/9.png'), md(c.paradox), img('https://media.giphy.com/media/rAZEnOu0KHQK4/giphy.gif', '', { width: '100%' }), img('./images/10.png'), md(c.compilers), img('./images/11.png'), frame('https://goo.gl/RRLvm8'), img('./images/12.png'), md(c.fp), frame('https://goo.gl/tbhizV'), md("\n# Thanks, V8!\n"), md(c.quote1), img('./images/13.png'), md(c.npm), img('./images/18.png'), img('./images/19.png'), md(c.contextless), img('./images/21.png'), img('./images/22.png'), img('./images/23.png'), md("\n# A simple fetch()\n"), frame('https://goo.gl/gU8gk3'), md("\n# A cancellable fetch()\n"), frame('https://goo.gl/gcfTJk'), md("\n# A batchable fetch()\n"), frame('https://goo.gl/MZo6xb'), md("\n# A cancellable-batchable fetch()\n"), frame('https://goo.gl/4gxYf8'), md("\n# A multiplexed fetch()\n"), frame('https://goo.gl/sZsLrk'), md(c.quote2), md(c.lessons1),
    // HERE: look at fetch, cancellable, batch, mux
    (0, _universalUtils.m)('div', (0, _universalUtils.m)('h2', "It's a bit of a side quest"), tweet('657880905567096832')), md("\n# \"Dirtual Voms\"\n"), md("\n# JSX. Transpiled.\n"), frame('https://goo.gl/RROheS'), md("\n# An example React element (VDOM object)\n"), frame('https://goo.gl/DNQDVJ'), md("\n# It's a recursive object tree!\n"), frame('https://goo.gl/KjCmNK'), frame('https://goo.gl/HiKBJH'), img('./images/vdom.png'), img('./images/matt.png'), md("\n# Redux and the Tyranny of \"State\"\n"), img('./images/20.png'), md(c.reduxWeaknesses), frame('https://goo.gl/g7jxbP'), frame('https://goo.gl/Z6oN9k'), md("\n# Async actions\n\n---\n\n- middleware\n- thunks\n\n"), frame('https://goo.gl/5H69wc'), img('./images/28.png'), md(c.store), frame('https://goo.gl/meGXlP'), md("\n# Have We lost faith in our own API design skills/needs?\n"), md("\n# Channels, the new tacos.\n"), frame('https://goo.gl/AziEvr'), frame('https://goo.gl/6PdBln'), md("\n# Transducers = transform + reduce\n"), frame('https://goo.gl/GnbP9M'), md("\n ## \"Ottomation\" - Hashicorp's Revenge and the War for Automation \n"), md(c.otto), img('./images/kintsugi.jpg'), md("\n# Thank You!\n"));
...
},{"./content":2,"babel-polyfill":3,"isomorphic-fetch":192,"universal-utils":198,"vdom-slide-engine":205}],2:[function(require,module,exports){
"use strict";
...
},{"whatwg-fetch":206}],193:[function(require,module,exports){
...
},{"isomorphic-fetch":204}],197:[function(require,module,exports){
"use strict";
...
},{"./cache":194,"./csp":195,"./fetch":196,"./fp":197,"./mux":199,"./resource":200,"./router":201,"./store":202,"./vdom":203}],199:[function(require,module,exports){
'use strict';
...
},{"./fetch":196,"./store":202}],200:[function(require,module,exports){
'use strict';
...
},{"./cache":194,"./fetch":196,"./store":202}],201:[function(require,module,exports){
'use strict';
...
*/
},{"./fetch":196}],203:[function(require,module,exports){
(function (global){
'use strict';
...
},{"dup":192,"whatwg-fetch":206}],205:[function(require,module,exports){
'use strict';
...
},{"universal-utils":198}],206:[function(require,module,exports){
(function() {
  'use strict';
